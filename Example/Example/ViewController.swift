...
class ViewController: UITableViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        // auto layout        
        textField.centerYAnchor.constraint(equalTo: self.codeView.centerYAnchor).isActive = true
        textField.leadingAnchor.constraint(equalTo: self.codeView.leadingAnchor, constant: 10).isActive = true
        textField.trailingAnchor.constraint(equalTo: self.codeView.trailingAnchor, constant: -10).isActive = true
